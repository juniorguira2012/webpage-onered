  ...
  return (
    <div className="space-y-4 text-sm text-gray-700 leading-relaxed text-left">
      ...
      <div>
        ...
        <ul className="list-disc pl-5 space-y-1 text-xs">
          <li><strong>Equipos en Préstamo:</strong> Los equipos entregados (Terminal de red Óptica, routers, antenas) permanecen bajo propiedad de ONERED JWG532, S.R.L. en calidad de comodato y deberán ser devueltos en buen estado al momento de la cancelación.</li>
